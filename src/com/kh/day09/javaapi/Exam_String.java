...
public class Exam_String {
	public static void main(String[] args) {
		...
		// 문자열 포함
		System.out.println("#이 있는가> : " + data1.contains("#")); // contains : 해당 문자열 안에 내가 찾는 단어가 있는가?
		
		// 문자열 연결
		data1 = data1.concat(data2); // C#, C++
		System.out.println("연결된 문자열 : " + data1); // 공백도 문자열로 취급이 됨.
		...
		// 몇개인지 몰라도 전부 출력되게끔 하기 위해서 for문 사용
...
//		System.out.println("문자열 자르기 : " + data1);
		...
		// 지정한 범위의 -1 된 길이까지 잘리기 때문에 원하는 위치 +1 한 위치를 설정해야한다.
