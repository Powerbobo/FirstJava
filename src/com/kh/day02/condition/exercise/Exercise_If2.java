...
//		System.out.println("주문하시겠어요? (에스프레소, 카푸치노, 카페라떼, 아메리카노) :");
//		String menu = sc.next();
//		switch(menu) {
//			case "에스프레소" : System.out.println("가격은 3500원입니다."); break;
//			case "카푸치노" : System.out.println("가격은 3500원입니다."); break;
//			case "카페라떼" : System.out.println("가격은 3500원입니다."); break;
//			case "아메리카노" : System.out.println("가격은 2000원입니다."); break;	
