...
public class Exercise_RadioButtonItrmEvent extends JFrame{
	...
	public Exercise_RadioButtonItrmEvent() {
		setTitle("RadioButtonItemEvent 만들기");
		...
		for(int i = 0; i < fruits.length; i++) {	
			...
			fruits[i].addItemListener(new ItemListener() {
				...
				public void itemStateChanged(ItemEvent e) {
					...
					if(fruits[0].isSelected()) {		// setIcon() 메소드 처음 써 봄, Label 이미지를 Set하게 도와주는 메소드
	...
	public static void main(String[] args) {
		...
		new Exercise_RadioButtonItrmEvent();
	}
